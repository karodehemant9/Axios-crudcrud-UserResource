...
let users;
let storedUsers = axios.get("https://crudcrud.com/api/f5d82d8b4afc4f03a6035a449e513e92/appointmentData");
storedUsers
.then((response) => {
    users = [...response.data] || [];
...
function saveUsersToCrudCrudServer(user) {
    axios.post("https://crudcrud.com/api/f5d82d8b4afc4f03a6035a449e513e92/appointmentData", user)
    .then((response) => {
...
function editUserOnCrudCrudServer(userID, user) {
    axios.put(`https://crudcrud.com/api/f5d82d8b4afc4f03a6035a449e513e92/appointmentData/${userID}`, user)
    .then((response) => {
        // Display the updated list
        location.reload();
        displayUsers();
...
function deleteUsersFromCrudCrudServer(userID) {
    axios.delete(`https://crudcrud.com/api/f5d82d8b4afc4f03a6035a449e513e92/appointmentData/${userID}`)
    .then((response) => {
        console.log(response);
        location.reload();
        displayUsers();
...
function editUser(index) {
    ...
    userForm.addEventListener('submit', (e) => {
        ...
        if (name === null || email === null || phoneNumber === null) {
            ...
            editUserOnCrudCrudServer(editedUser._id, tempUser);
